...
Os dez infográficos seguem a ordem do [índice visual](assets/infograficos/README.md). As ilustrações são esquemáticas. Cores, setas, vetores e caixas explicam relações conceituais; não representam medições de um experimento. As fontes primárias e as APIs utilizadas estão reunidas em [REFERENCIAS.md](REFERENCIAS.md).
